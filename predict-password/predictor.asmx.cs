...
{
    /// <summary>
    /// Summary description for predictor
    /// </summary>
    ...
    public class predictor : System.Web.Services.WebService
    {
...

        {
            ...
            {
                CloudBlockBlob blob = container.GetBlockBlobReference("full_passwords.txt");
                ...
                using (StreamReader reader = new StreamReader(this.filePath))
                {
                    ...
                    while (passwords.Count() < 20000000)
                    {
                        //if (count % 1000 == 0)
                        //{
